              ...
              <div key={v.id} className="am-item">
                ...
                <div className="am-item-right am-info">
                  ...
                  <div className="am-info-item">
                    ...
                    <div className="value">{info.etaDate} <span className="muted">({info.etaDays}d)</span></div>
                  </div>

                  <div className={`am-info-item unresolved ${info.unresolved ? "has" : "none"}`}>
                    <div className="label">Unresolved</div>
                    <div className="value">{info.unresolved > 0 ? `${info.unresolved} issue${info.unresolved>1?"s":""}` : "None"}</div>
                  </div>

                  <Link to={`/vehicles`} className="am-details">View</Link>
                </div>
              </div>
            );
          })}
